...
The repository for [acid.info](https://acid.info/) website.
...
- [CI builds](https://ci.infra.status.im/job/website/job/acid.info/) `master` and pushes to `deploy-master` branch, which is hosted at <https://acid.info//>.
- [CI builds](https://ci.infra.status.im/job/website/job/dev.acid.info/) `develop` and pushes to `deploy-develop` branch, which is hosted at <https://dev.acid.info//>.
