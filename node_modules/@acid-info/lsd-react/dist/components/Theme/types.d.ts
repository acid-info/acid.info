...
export type TypographyVariants = 'display1' | 'display2' | 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'subtitle1' | 'subtitle2' | 'body1' | 'body2' | 'body3' | 'label1' | 'label2';
...
export type ThemeOptionBreakpointStyles = Partial<Omit<BreakpointStyles, 'width' | 'typography'> & {
    width?: number;
