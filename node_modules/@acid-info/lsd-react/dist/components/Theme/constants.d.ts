import { Breakpoints, TypographyGenericFontFamily, TypographyVariants } from './types';
...
export declare const THEME_TYPOGRAPHY_ELEMENTS: Partial<Record<TypographyVariants, string[]>>;
export declare const THEME_TYPOGRAPHY_PROPERTIES: ("fontFamily" | "fontSize" | "lineHeight")[];
